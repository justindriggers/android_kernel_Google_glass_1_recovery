...
// Complete SWAG.  Use offsets and TI's table for their pcb sensor.
// TODO:(rocky) Really need to recalculate adc_to_temp table.
#define TWL6030_ADC_START_VALUE (126-90)
#define TWL6030_ADC_END_VALUE   (978-90)
#define TWL6030_GPADC_CHANNEL     6
/*
 * Temperature values in milli degrees celsius ADC code values from 978-90 to 126-90
 */
