...
#define KEY_D_GLU_STATE             (KEY_X_GRT_Y_TMP2 + 1)
#define KEY_D_GLU_INTERRUPT         (KEY_D_GLU_STATE + 1)
#define KEY_D_GLU_GZ_THRESHOLD      (KEY_D_GLU_INTERRUPT + 1)
#define KEY_D_GLU_MAX_ACCEL_THRESHOLD (KEY_D_GLU_GZ_THRESHOLD + 1)
#define KEY_D_GLU_MIN_ACCEL_THRESHOLD (KEY_D_GLU_MAX_ACCEL_THRESHOLD + 1)
#define KEY_D_GLU_LEVEL_THRESHOLD   (KEY_D_GLU_MIN_ACCEL_THRESHOLD + 1)
#define KEY_D_GLU_TRIGGER_THRESHOLD (KEY_D_GLU_LEVEL_THRESHOLD + 1)
...
#define KEY_D_AUTH_OUT              (KEY_D_GLU_ROLL_THRESHOLD + 1)
