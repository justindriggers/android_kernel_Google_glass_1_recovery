...
#define GLU_CHECK_STATE_1       (1175)
#define GLU_CHECK_STATE_0       (1126)
#define CFG_27                  (2800)
#define GLU_CHECK_STATE_2       (1151)
#define CFG_20                  (2219)
#define CFG_23                  (2803)
#define CFG_FIFO_ON_EVENT       (2749)
#define CFG_ORIENT_IRQ_1        (2674)
#define X_GRT_Y_TMP             (1459)
#define END_ORIENT_1            (1850)
#define CFG_DR_INT              (1029)
#define CFG_16                  (2804)
#define CFG_AUTH                (1035)
#define FCFG_1                  (1062)
#define SKIP_X_GRT_Y_TMP        (1460)
#define SKIP_END_COMPARE        (1536)
#define FCFG_3                  (1251)
#define FCFG_2                  (1066)
#define GLU_END_2               (1169)
#define GLU_END_3               (1191)
#define FCFG_7                  (1076)
#define FCFG_6                  (1269)
#define GLU_END_4               (1209)
#define NO_ORIENT_INTERRUPT     (1866)
#define GLU_END_5               (1219)
#define CFG_8                   (2778)
#define CFG_15                  (2786)
#define GLU_END_1               (1145)
#define END_COMPARE_Y_X_TMP     (1508)
#define CFG_6                   (2807)
#define CFG_7                   (1362)
#define END_COMPARE_Y_X         (1585)
#define END_COMPARE_Y_X_TMP2    (1556)
#define CFG_LP_QUAT             (2772)
#define END_ORIENT              (1879)
#define GLU_STATE_2             (1161)
#define GLU_STATE_0             (1136)
#define GLU_STATE_1             (1184)
#define CFG_MOTION_BIAS         (1365)
#define X_GRT_Y                 (1509)
#define TEMPLABEL               (2319)
#define NOT_TIME_MINUS_1        (1669)
#define CFG_DISPLAY_ORIENT_INT  (1847)
#define END_COMPARE_Y_X_TMP3    (1535)
#define X_GRT_Y_TMP2            (1480)
...
static const struct tKeyLabel dmpTConfig[] = {
	...
	{KEY_D_GLU_OUTLIER,         D_GLU_OUTLIER},
