...
#define DLH_ODR5		0xA0  /* 5Hz output data rate */
#define DLH_ODR10		0xC0  /* 10Hz output data rate */
#define DLH_ODR50		0x20  /* 50Hz output data rate */
#define DLH_ODR100		0x28  /* 100Hz output data rate */
#define DLH_ODR400		0x30  /* 400Hz output data rate */
#define DLH_ODR1000		0x38  /* 1000Hz output data rate */
...
int lsm303dlhc_acc_update_g_range(struct lsm303dlhc_acc_data *acc,
							u8 new_g_range)
{
	int err=-1;
...
int lsm303dlhc_acc_update_odr(struct lsm303dlhc_acc_data *acc,
...
static struct device_attribute attributes[] = {
	...
	__ATTR(click_timelimit, 0666, attr_get_click_tlim, attr_set_click_tlim),
