/*
 * Toshiba TC358762 bridge chip panel support
 *
 * Based on Toshiba TC358765 support by TI:
...
/* Pseudo-register used to insert a delay into the init sequence. */
...
#define    LCDCTRL_PORT                  0x0420                /*  LCDC Control, RGB Output Polarity */
  ...
  #define  LCDCTRL_RGB666_LOOSE          0x0010                /*  RGB666 loosely packed 18 bits per pixel */
  ...
  #define  PORT_DE_INVERTED              0x0004                /*  Assert "0" when valid data is output */
  #define  PORT_HSYNC_INVERTED           0x0002                /*  Assert "1" during H-sync */
#define    HSR_HBPR                      0x0424                /*  Horiz. Sync Rate, Horiz. Back Porch */
#define    HDISPR_HFPR                   0x0428                /*  Horiz. Display Size, Horiz. Front Porch */
#define    VSR_VBPR                      0x042C                /*  Vert. Sync Low Pulse Width, Vert. Back Porch */
#define    VDISPR_VFPR                   0x0430                /*  Vert. Display Size, Vert. Front Porch */
